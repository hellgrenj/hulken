...
exports.createExampleOptions = function(appUrl){
  var hulken_options = {
    targetUrl: appUrl,
  ...
  fs.writeFile('./options.json', JSON.stringify(
    ...
    if (err) {
      ...
      printer.print('see other settings you can override and their default values at:'.white.inverse);
      printer.print('https://github.com/hellgrenj/hulken#usage-as-a-library'.white.inverse + '\n');
    }
  });
}
